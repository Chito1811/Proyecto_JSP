...
<article id="card">
		...
		<form id="miFormulario" action="updateUser.jsp">
		<div class="input-field">
                ...
                <div style="display: flex; align-items: center; " class="input-field">
                ...
                <div class="input-field">
                    <input readonly type="text" name="username" id="username" placeholder="Username" value="<%= uname %>" />
                </div>
